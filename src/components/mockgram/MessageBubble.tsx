...
function CopyableCode({ text }: { text: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="inline max-w-full bg-transparent p-0 text-left font-mono text-[1em] text-inherit transition-[color,filter] duration-200 hover:bg-transparent hover:text-[#c7dbff] hover:drop-shadow-[0_0_6px_rgba(120,180,255,0.45)] whitespace-pre-wrap break-all"
